...
var Knex, app, async, errorHandler, express, getFirstnames, getSurnames, knex, queries, randomIntFromInterval, server, _;
...
app.get("/api/names", function(req, res) {
  return async.parallel([
    ...
    if (errors.length > 0) {
      ...
      _.each(cleanedResults['names'], function(nameArray) {
        ...
        if (_.isUndefined(nameArray[1])) {
          return nameArray[1] = results[1].surnames[randomIntFromInterval(0, surMax)];
        }
      });
