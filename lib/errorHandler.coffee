...
errorCodes = {
  ...
  invalid_race_pct: {message: 'Invalid race percent specified', description: 'An invalid race percentage was requested. Minimum request is 1 and maximum is 99.', code: 5},
